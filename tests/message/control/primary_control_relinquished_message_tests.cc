...
TEST_GROUP(PrimaryControlRelinquishedMessageTest){
    // SETUP
};

TEST(PrimaryControlRelinquishedMessageTest, Validate) {
  auto valid_header =
...
TEST(PrimaryControlRelinquishedMessageTest, ToJson) {
  PrimaryControlRelinquishedMessage message =
      PrimaryControlRelinquishedMessageBuilder()
...
TEST(PrimaryControlRelinquishedMessageTest, FromJson) {
  ...
  PrimaryControlRelinquishedMessage message =
      PrimaryControlRelinquishedMessage::FromJson(json);
