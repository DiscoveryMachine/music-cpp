...
TEST_GROUP(ControlReclamationMessageTest){
    // SETUP
};

TEST(ControlReclamationMessageTest, Validate) {
  auto valid_header =
  ...
  ControlReclamationMessage message = ControlReclamationMessageBuilder()
...
TEST(ControlReclamationMessageTest, ToJson) {
  ControlReclamationMessage message = ControlReclamationMessageBuilder()
...
TEST(ControlReclamationMessageTest, FromJson) {
  ...
  ControlReclamationMessage message = ControlReclamationMessage::FromJson(json);
