...
TEST_GROUP(ControlGrantedMessageTest){
    // SETUP
};

TEST(ControlGrantedMessageTest, Validate) {
  auto valid_header =
...
TEST(ControlGrantedMessageTest, ToJson) {
  ControlGrantedMessage message = ControlGrantedMessageBuilder()
...
TEST(ControlGrantedMessageTest, FromJson) {
  ...
  ControlGrantedMessage message = ControlGrantedMessage::FromJson(json);
