...
TEST_GROUP(PrimaryControlGrantedMessageTest){
    // SETUP
};

TEST(PrimaryControlGrantedMessageTest, Validate) {
  auto valid_header =
  ...
  PrimaryControlGrantedMessage message = PrimaryControlGrantedMessageBuilder()
...
TEST(PrimaryControlGrantedMessageTest, ToJson) {
...
TEST(PrimaryControlGrantedMessageTest, FromJson) {
  ...
  PrimaryControlGrantedMessage message =
      PrimaryControlGrantedMessage::FromJson(json);
