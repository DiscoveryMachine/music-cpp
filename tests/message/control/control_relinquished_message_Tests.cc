...
TEST_GROUP(ControlRelinquishedMessageTest){
    // SETUP
};

TEST(ControlRelinquishedMessageTest, Validate) {
  auto valid_header =
  ...
  ControlRelinquishedMessage message = ControlRelinquishedMessageBuilder()
...
TEST(ControlRelinquishedMessageTest, ToJson) {
...
TEST(ControlRelinquishedMessageTest, FromJson) {
  ...
  ControlRelinquishedMessage message =
      ControlRelinquishedMessage::FromJson(json);
