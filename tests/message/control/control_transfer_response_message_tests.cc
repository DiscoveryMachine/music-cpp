...
TEST_GROUP(ControlTransferResponseMessageTest){
    // SETUP
};

TEST(ControlTransferResponseMessageTest, Validate) {
  auto valid_header =
...
TEST(ControlTransferResponseMessageTest, ToJson) {
  ControlTransferResponseMessage message =
      ControlTransferResponseMessageBuilder()
...
TEST(ControlTransferResponseMessageTest, FromJson) {
  ...
  ControlTransferResponseMessage message =
      ControlTransferResponseMessage::FromJson(json);
