...
TEST_GROUP(ControlTransferGrantedMessageTest){
    // SETUP
};

TEST(ControlTransferGrantedMessageTest, Validate) {
  auto valid_header =
  ...
  ControlTransferGrantedMessage message = ControlTransferGrantedMessageBuilder()
...
TEST(ControlTransferGrantedMessageTest, ToJson) {
...
TEST(ControlTransferGrantedMessageTest, FromJson) {
  ...
  ControlTransferGrantedMessage message =
      ControlTransferGrantedMessage::FromJson(json);
