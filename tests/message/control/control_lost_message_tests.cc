...
TEST_GROUP(ControlLostMessageTest){
    // SETUP
};

TEST(ControlLostMessageTest, Validate) {
  auto valid_header =
...
TEST(ControlLostMessageTest, ToJson) {
  ControlLostMessage message = ControlLostMessageBuilder()
...
TEST(ControlLostMessageTest, FromJson) {
  ...
  ControlLostMessage message = ControlLostMessage::FromJson(json);
