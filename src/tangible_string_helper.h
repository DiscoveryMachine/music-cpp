...
#ifndef TANGIBLE_STRING_HELPER_H
#define TANGIBLE_STRING_HELPER_H
...
{
public:
	//Added functions by DiscoveryMachine developers
	/// Boost's json library takes strings only. This is to convert the wstring consts to string
	...
	static std::wstring stringToWString(std::string str)
	{
		...
		int w_size = MultiByteToWideChar(CP_UTF8, 0, str.c_str(), -1, NULL, 0);
		wchar_t *wstr = new wchar_t[w_size];
		MultiByteToWideChar(CP_UTF8, 0, str.c_str(), -1, wstr, w_size);
		return wstr;
	}

	static std::wstring stringToWString(boost::json::string str)
	{
		if (str.empty())
		{
			return std::wstring();
	...
	/////////////////////////////////////////Below is Auto Generated from C# to C++ converter (Provided by, Tangible Software Solutions, Inc.)
...
#endif // !TANGIBLE_STRING_HELPER_H